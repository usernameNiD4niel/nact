...
const AddSupplier = () => {
	return (
		<div className={`${headerBackClass} lg:flex flex-col items-center`}>
			<HeaderWithBack text="Add Supplier" route="/supplier" />
			<div className="py-2 mt-12 px-4 lg:w-[60%]">
					...
					{CustomerType.map((value, index) => (
						<li key={index}>
							<Link
								...
								className="flex flex-col md:p-3 p-2 pb-0 border-b-black border-opacity-20 border-b-[1px] w-full">
