		...
		<main className="w-full p-4 space-y-2">
			...
			<div className="flex flex-wrap w-full gap-y-2 sm:gap-5">
				{cardData.map((data, index) => (
					<div
						className={`rounded-md flex flex-col w-full sm:w-[45%] lg:w-64 p-5 card${index} hover:opacity-70 transition-opacity duration-150 delay-75 hover:cursor-pointer`}
						key={index}>
