...
const SideNavigation = () => {
	...
	return (
		<aside className="max-w-[370px] w-full md:w-full bg-primary h-full flex flex-col pt-5 pb-2 z-[100] md:items-center">
			...
			<ul className="mt-10 flex flex-col justify-between h-full w-full">
				<div>
					<li>
						<Link
							to="/"
							className={`${buttonClass} ${activeButtonClass} hover:${activeButtonClass}`}>
					...
					<li>
						<Link
							to="/sale"
							className={`${buttonClass} hover:${activeButtonClass}`}>
