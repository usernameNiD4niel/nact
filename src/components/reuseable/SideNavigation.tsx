...
const SideNavigation = () => {
	...
	return (
		<aside className="max-w-[370px] w-full fixed top-0 md:w-[30%] xl:w-full left-0 bottom-0 drop-shadow-md hidden md:flex bg-primary flex-col pt-5 pb-2 z-40 md:items-center">
